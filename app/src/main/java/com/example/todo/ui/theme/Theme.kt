...
import com.example.todo.ui.theme.PurpleGrey40
...
fun ToDoTheme(
    ...
    // It makes the system bars match the app's background color.
    val systemUiController = rememberSystemUiController()
    val useDarkIcons = !darkTheme

    DisposableEffect(systemUiController, useDarkIcons) {
        systemUiController.setSystemBarsColor(
            // Use the background color from your chosen color scheme
